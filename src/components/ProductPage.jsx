            ...
            <div className='min-w-[1000px] max-w-[1600px] m-auto p-4'>
                <div className='grid grid-cols-10 gap-2'>
                    ...
                    <div className='col-span-2 p-4 rounded bg-white'>
                        ...
                        <Link to="/checkout">
                            <button onClick={() => dispatch(addToCart(addQuantityToProduct()))} className='bg-yellow-400 w-full p-3 text-xs xl:text-sm rounded hover:bg-yellow-500'>Add to Cart</button>
                        </Link>
                    </div>
                </div>
            </div>
